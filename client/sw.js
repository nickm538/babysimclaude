// Minimal PWA service worker: cache the app shell, network-first for everything dynamic.
const CACHE = 'cradle-v1';
const SHELL = ['/', '/index.html', '/manifest.webmanifest', '/icon.svg', '/src/ui/styles.css'];
